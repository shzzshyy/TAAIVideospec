...
#  s.libraries  = 'c++','sqlite3','z'
  ...
  s.dependency 'Chivox'
  s.dependency 'ITGKit/Base'
  s.dependency 'ITGInterface/User'
  s.dependency 'SensorsAnalyticsSDK'
  s.dependency 'ITGFoundation/Module'
  s.dependency 'ITGFoundation/Route'
  s.dependency 'ITGInterface/TAGlobalConfiguration'
